...
# Define an embedding function conforming to ChromeDB's EmbeddingFunction interface
...
collection = client.get_or_create_collection(
    ...
    embedding_function=embedding_func  # Correctly wrapped embedding function
)
